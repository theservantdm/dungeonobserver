...
function GenerateNPC(name, size, type, alignment, AC, hpMax, hitDice, speed, speedClimb, speedFly, abilityScores, damageVul, damageRes, damageImm, conditionImm, senses, languages, CR, traits, actions, bonusActions) {
	this.name = name;
	this.size = size;
	this.type = type;
...
function RandomNPC0() {
	switch(Dice(2)) {
		case 1:
			return new GenerateNPC("Bat", "tiny", "beast", "unaligned", 12, 1, [1,4], 5, 5, 30, [2,15,8,1,12,4], [], [], [], [], ["blindsight 60"], ["none"], 0, ["echolocation","keen hearing"],{attack:["bite",0,5,[1,1],0,"piercing"]},[]);
			break;
		case 2:
...
function RandomNPC1_4() {
	switch(Dice(2)) {
		case 1:
			return new GenerateNPC("Swarm of Bats", "medium", "beast", "unaligned", 13, 22, [4,10], 10, 10, 60, [5,15,10,2,12,4], [], ["bludgeoning","piercing","slashing"], [], ["charmed","frightened","grappled","paralysed","petrified","prone","restrained","stunned"], ["blindsight 60"], ["none"], 1/4, ["echolocation","keen hearing","swarm"],{attack:["bite",4,0,[4,2],0,"piercing"],weakAttack:["bite",4,0,[4,1],0,"piercing"]},[]);
			break;	
		case 2:
			return new GenerateNPC("Giant Bat", "large", "beast", "unaligned", 12, 22, [5,8], 0, 0, 30, [15,16,11,2,12,6], [], [], [], [], ["blindsight 60"], ["none"], 1/4, ["echolocation","keen hearing"],{attack:["bite",4,5,[6,1],2,"piercing"]},[]);
			break;
	};
};
